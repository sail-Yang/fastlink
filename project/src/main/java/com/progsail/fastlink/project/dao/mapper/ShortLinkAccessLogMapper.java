 ...
 * @date 2024/8/8 16:48
 */
public interface ShortLinkAccessLogMapper extends BaseMapper<ShortLinkAccessLogDO> {
    /**
    ...
    @Select("SELECT " +
            ...
            "    count DESC " +
            "LIMIT 5;")
    List<HashMap<String,Object>> listTopIpBySingleShortLink(@Param("param") ShortLinkStatsReqDTO requestParam);
